...
public class To_check_ssl_with_fullcode {
...
//	Precedence Wise Execution:
	...
	public void pre_enq_upto_GetScore() throws InterruptedException, AWTException {
				...
				spark = new ExtentSparkReporter("/home/aditya/eclipse-workspace/AUTOMATION_PROJECT/Extent_reports");
				...
				test = extent.createTest("Upto_GetScore");
